...
// 1) Webhook: RAW primero de todo, antes de cualquier otro middleware
    ...
    case 'checkout.session.completed':
      ...
      try {
        ...
        if (!adId || !userId) {
          ...
          // Devolver 200 para que Stripe considere el webhook como procesado
...
app.get("/config.js", (req, res) => {
  ...
  res.send(`window.__STRIPE_PK__ = ${JSON.stringify(pk)};`);
});

...
export const initStripe = async () => {
  // Usar la configuración del backend para inicializar Stripe
  const { initStripeWithBackendConfig } = await import('./stripeBackendConfig');
  return initStripeWithBackendConfig();
};